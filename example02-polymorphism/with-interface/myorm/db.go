...
// MySQL is a struct that represents a MySQL database connection and provides
// methods for performing database operations specific to MySQL.
type MySQL struct {
	Conn *sql.DB
}
...
// Postgres is a struct that represents a Postgres database connection and provides
// methods for performing database operations specific to Postgres.
